...
const url = "mongodb://localhost:27017/kahootDB"; // URL de la base de datos

mongoose.connect(url, { useNewUrlParser: true, useUnifiedTopology: true }); // Conexión a MongoDB

const db = mongoose.connection; // Obtener la conexión

db.on('error', console.error.bind(console, 'Error de conexión a MongoDB:')); // Manejar errores de conexión

db.once('open', function() {
    console.log("Conexión exitosa a MongoDB"); // Confirmar la conexión exitosa
});
